...
{0x15, 0x35, 1, {0x00}}, /* TE */
{0x15, 0x51, 1, {0xFF}}, /* Write Display Brightenss Value*/
{0x15, 0x53, 1, {0x24}}, /* Write CTRL Display Value */
{0x15, 0x55, 1, {0xB0}}, /* Color Enhancement HIGH  & CABC*/
...
{0x15, 0x21, 1, {0x01}},
{0x15, 0x30, 1, {0x01}},
{0x15, 0x31, 1, {0x02}},    //2dot inversion
{0x15, 0x40, 1, {0x12}},
{0x15, 0x41, 1, {0x33}},
{0x15, 0x42, 1, {0x03}},
{0x15, 0x43, 1, {0x09}},
...
static void lcm_get_params(LCM_PARAMS * params)
{
   ...
   // params->dsi.vertical_vfp_lp = 228;
	...
	// Bit rate calculation
	params->dsi.PLL_CLOCK = 246;  //FTE 3.6ms, fps 60

	LCM_PRINT("lcm_get_params jongmahn.kim@lge.com \n");
...
static void init_lcm_registers(void)
{
    ...
    if(cabc_mode == 0){
        data_array[0] = 0xB0551500; /* CABC disable */
        dsi_set_cmdq(data_array, 1, 1);
        LCM_PRINT("cabc_mode 0\n");
    }else if(cabc_mode == 1){
//        data_array[0] = 0x945E1500; /* min Brightenss CABC */
//        dsi_set_cmdq(data_array, 1, 1);
        data_array[0] = 0xB1551500; /* User Interface Image mode */
        dsi_set_cmdq(data_array, 1, 1);
        LCM_PRINT("cabc_mode 1\n");
    }else if(cabc_mode == 2){
//        data_array[0] = 0x945E1500; /* min Brightenss CABC */
//        dsi_set_cmdq(data_array, 1, 1);
        data_array[0] = 0xB2551500; /* Still Picture mode */
        dsi_set_cmdq(data_array, 1, 1);
        LCM_PRINT("cabc_mode 2\n");
    }else if(cabc_mode == 3){
//        data_array[0] = 0x945E1500; /* min Brightenss CABC */
//        dsi_set_cmdq(data_array, 1, 1);
        data_array[0] = 0xB3551500; /* Moving Image mode */
        dsi_set_cmdq(data_array, 1, 1);
        LCM_PRINT("cabc_mode 3\n");
    }
...
static void init_lcm_registers_sleep(void)
{
	...
	LCM_PRINT("init_lcm_registers_Display_off \n");
}
...
static void init_lcm_registers_sleep_cmd(void)
{
	...
	LCM_PRINT("init_lcm_registers_sleep_cmd \n");
}
...
{
//    pmic_set_register_value(PMIC_RG_VRF18_1_VOSEL, 3);
 //   pmic_set_register_value(PMIC_RG_VRF18_1_EN, 1);
}
...
{
   // pmic_set_register_value(PMIC_RG_VRF18_1_VOSEL, 0);
}
/*
...
static void lcm_init(void)
{
	...
	*/
	...
	LCM_PRINT("lcm_init jongmahn.kim@lge.com \n");
}
